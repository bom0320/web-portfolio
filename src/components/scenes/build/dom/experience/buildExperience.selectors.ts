export const BUILD_EXPERIENCE_SELECTORS = {
  ...
  ai: {
    header: ".js-ai-capability-header",
    grid: ".js-ai-capability-grid",
    cards: ".js-ai-capability-card",
    cardIcons: ".js-ai-capability-card-icon",
    cardSubtitles: ".js-ai-capability-card-subtitle",
    cardTitles: ".js-ai-capability-card-title",
    cardMessages: ".js-ai-capability-card-message",
    cardDescs: ".js-ai-capability-card-desc",
  },

  visual: {
    header: ".js-visual-capability-header",
  },
} as const;
